...
echo '<li>';
	...
	if($arr[15]==1){
		...
		$color='style="background-color: #2fff00;"';
	}
		...
		echo '<div class="top-notice">';
			...
			if($arr[5]=="Hot")
			 ...
			 echo '<span class="type-label video">Anime</span>';
		echo '</div>';
	 ...
	 foreach($arr as $arr3) {
	   ...
	   echo '<li>';
			echo '<div class="story-item">';
				...
				echo '<img class="story-cover lazy_cover" src="'.$arr3["Img"].'" alt="'.$arr3["Name"].'" style="width:190px;height:247px;"/>';
				echo '</a>';
	            	echo '<div class="top-notice">';
			        echo '<span class="time-ago" '.$color.'>'.$dateChap.'</span>';
...
function storiesList($arr,$linkOption){	  
	...
	echo '<ul class="list-stories grid-6">';
	 foreach($arr as $arr3) {
	   ...
	   echo '<li>';
			echo '<div class="story-item"><strong>';
