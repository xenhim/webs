                        ...
                        return i(this, function(i) {
                            ...
                            case 4:
                                if ((c = i.sent()).isOpen || c.directReturn)
                                    return e && (c.checkerName = e + "." + c.checkerName),
                                    [2, c];
                                i.label = 5;
                            case 5:
                                return n++,
        ...
        var r = n(0)
          ...
          , u = function() {
            ...
            return t.prototype.lanuch = function() {
                ...
                this._detectLoopStoped && (this._detectLoopStoped = !1,
                this._detectLoop())
            }
            ,
            t.prototype.stop = function() {
                this._detectLoopStoped || (this._detectLoopStoped = !0,
            ...
            t.prototype._detectLoop = function() {
                return o(this, void 0, void 0, function() {
                    ...
                    return i(this, function(n) {
                        ...
                        case 1:
                            return (t = n.sent()).isOpen != this._isOpen && (this._isOpen = t.isOpen,
                            this._broadcast(t)),
