        ...
        <div class="level">
            ...
            <div class="level-right">
                <ul class="top-links pc">
                    <li>
                        <a href="https://xemtruyen.xyz/lich-su.html">Lịch sử</a>
                    </li>
                    <li>
                        <a href="https://xemtruyen.xyz/truyen-dang-theo-doi.html">Theo dõi</a>
                    </li>
                    <li>
                        ...
                        <div class="list-messages">
                            ...
                            <ul>
                                ...
                                <li class="message unread">
                                    <a href="https://xemtruyen.xyz/truyen-tranh/fairy-tail-100-year-quest-5212-chap-54.html">
                                ...
                                <li class="message ">
                                    <a href="https://xemtruyen.xyz/truyen-tranh/tien-vuong-trung-sinh-7879.html">
                                        <div class="title-message-item">Thông Báo</div>
                                ...
                                <li class="message ">
                                    <a href="https://xemtruyen.xyz/truyen-tranh/dap-toai-tien-ha-7719-chap-99.html">
                                        <div class="title-message-item">Thông Báo</div>
...
<div class="modal login-modal">
    ...
    <div class="modal-content">
        <span class="top-caption">
            ...
            đến giờ đọc truyện cứ vào xemtruyen
        </span>
        <div>
            <!-- /.top-caption -->
