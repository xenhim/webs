...
$error=$db->AddStory($Name,$NameOther,$Status,$Content,$Avatar,$Badge,$Waning,implode(",",$Author),$Genre,$NameEncodeGenres,$Country,$DateUpload,$URL1,$URL2,$female,$male);
$db->dis_connect();//ngat ket noi mysql	
$array=array("Error"=>"$error");

unlink("../../temp/".$tempStory);	
