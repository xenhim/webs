    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Dach sách thể loại</h3>
				   ...
				   for(var i=0;i<k[0].length;i++)
					{
							   html1+='<tr id="s'+k[0][i].Id+'">';
								 ...
								 html1+='<td class="project-actions text-left">'+k[0][i].Title+'</td>';
							
								 html1+='<td class="project-actions text-right"> <a class="btn btn-info btn-sm" href="editGenre.php?idGenre='+k[0][i].Id+'"><i class="fas fa-pencil-alt"></i></a>';
