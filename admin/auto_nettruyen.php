...
$path3 = "/var/www/vhosts/xemtruyen.xyz/httpdocs/wp-content/uploads/story/190x247/$slug/";
$path4 = "/var/www/vhosts/xemtruyen.xyz/httpdocs/wp-content/uploads/chap/manga/190x247/$slug/";
...
if (!file_exists("/var/www/vhosts/xemtruyen.xyz/httpdocs/wp-content/".$path2)) {
	 mkdir("/var/www/vhosts/xemtruyen.xyz/httpdocs/wp-content/".$path2, 0777, true);
}
...
if (isset($response['success']) && $response['success'] === true) {
	...
	$uploadedImageUrl = $response['result']['variants'][0];
		...
		$ii++;
		$sungs = $slug."-".$ii;
		$uploadedImageUrl = "https://imagedelivery.net/JDzrA2GqFSvC_q8u0OrkLQ/".$sungs."/public";
    ...
    foreach($x->query("//img") as $node)
    {
        ...
        if (!preg_match('#http#i', $node->getAttribute("src"))) {
            ...
            if($checkimg==1){
               // $ii++;
                $upload_location = "/uploads/chap/manga/".$slug."/".tofloat($chap2);
                if (!file_exists("/var/www/vhosts/xemtruyen.xyz/httpdocs/wp-content/".$upload_location)) {
                    mkdir("/var/www/vhosts/xemtruyen.xyz/httpdocs/wp-content/".$upload_location, 0777, true);
                }
...
foreach ($arr_img as $img) {
    ...
    if (isset($response['success']) && $response['success'] === true && isset($response['result']['variants'][0])) {
		...
		$ii++;
                ...
                copy($imageUrl,"/var/www/vhosts/xemtruyen.xyz/httpdocs/wp-content/".$upload_location."/".$ii.".jpg", $context_url);
                $data=("$imageUrl,'/var/www/vhosts/xemtruyen.xyz/httpdocs/wp-content/'.$upload_location.'/'.$ii.'.jpg', $context_url");
                echo $data."\n";
...
$path3 = "/var/www/vhosts/xemtruyen.xyz/httpdocs/wp-content/upload/story/190x247/$slug/";
$path4 = "/var/www/vhosts/xemtruyen.xyz/httpdocs/wp-content/upload/chap/manga/$slug/";
//echo $path4."\n";
//var_dump($path4);
	...
	$arr_img=array();
        ...
        if (!preg_match('#http#i', $node->getAttribute("src"))) {
            ...
            if($checkimg==1){
                ...
                //copy($cover,"../page/".$upload_location."/".$ii.".jpg", $context_url);
                $data=("$cover,'/var/www/vhosts/xemtruyen.xyz/httpdocs/wp-content/'.$upload_location.'/'.$ii.'.jpg', $context_url");
                //echo $data."\n";
                //$cover=$upload_location."/".$ii.".jpg";
            }
        }else{
