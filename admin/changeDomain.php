  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Thay đổi tên miền</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Thay đổi tên miền</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Thay đổi tên miền</h3>
            ...
            <div class="card-body">
             ...
             <div class="form-group">
                ...
                <input type="text" id="domain_old" class="form-control"><br>
                </div> 
              
                <div class="form-group">
                <label for="usr">Tên miền mới:</label><br>
                <input type="text" id="domain_new" class="form-control"><br>
