    ...
    <div class="sidebar">
      ...
      <div class="form-inline">
        <div class="input-group" data-widget="sidebar-search">
          <input class="form-control form-control-sidebar" type="search" placeholder="Search" aria-label="Search" id="SearchFeed">
          <div class="input-group-append">
...
function paginationEvent(per_page=5,page=1){
	  ...
	  var key=document.getElementById("SearchFeed").value;
				   ...
				   for(var i=0;i<k[0].length;i++)
					{
							   ...
							   html1+='<tr id="s'+k[0][i].Id+'">';
								 ...
								 html1+='<td><button data-id="'+k[0][i].Id+'" class="btnDelete btn btn-danger" title="Muốn xử lý">'+k[0][i].CheckFinish+'</button></td>';
...
$(document).ready(function(){
  ...
  $("#listFeed").on('click', '.btnDelete', function() {
