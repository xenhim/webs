  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Chặn bình luận</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Chặn bình luận</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Chặn bình luận</h3>
            ...
            <div class="card-body">
              <div class="form-group">
                <label for="inputName">Từ khóa chặn bình luận</label>
           
                
                 <textarea id="Name" class="form-control" rows="10" placeholder="Ví dụ: web,trang,thêm hoặc cấm chữi thề"></textarea>
              </div>
               <div class="form-group">
              <button type="button" class="btn btn-success" id="Save" src-image="" src-path="">Lưu</button>
               </div>
            </div>
            <!-- /.card-body -->
          </div>
