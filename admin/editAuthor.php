...
<?php
	...
	$arr_Author=$db->GetInfoAuthor($idAuthor);	
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="Name" class="form-control" value="<?php echo $arr_Author[1];?>"/>
              </div>
            </div>
            <!-- /.card-body -->
          </div>
      ...
      <div class="row">
        <div class="col-12">
          <button type="button" class="btn btn-success" id="editAuthor" src-image="" src-path="">Lưu</button>
        </div>
      </div>
    </section>
    <!-- /.content -->
