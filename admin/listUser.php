      ...
      <li class="nav-item">
        ...
        <div class="navbar-search-block">
            ...
            <div class="input-group input-group-sm">
              <input class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search" id="SearchUser">
				   ...
				   for(var i=0;i<k[0].length;i++)
					{
							   html1+='<tr id="s'+k[0][i].Id+'">';
								 html1+='<td class="project-actions text-left">'+k[0][i].Email+'</td>';
							
								 //html1+='<td class="project-actions text-left">'+k[0][i].LastName+'</td>';
							    
								 html1+='<td class="project-actions text-right"> <a class="btn btn-info btn-sm" href="roleUser.php?idUser='+k[0][i].Id+'"><i class="fas fa-pencil-alt"></i></a>';
							     //if(k[0][i].Level==0)
...
$(document).ready(function(){
  ...
  $("#SearchUser").keyup(function(){
   ...
   $("#listUser").on('click', '.hide_view', function() {
	   var id=$(this).attr("data-id");
