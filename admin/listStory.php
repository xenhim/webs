    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
         <a href="addStory.php"><button type="button" class="button is-danger btn btn-success"  title="Collapse">Thêm truyện</button></a>
			  ...
			  var html1="";
			    html1+='<table class="table  table-striped projects">';
				   ...
				   for(var i=0;i<k[0].length;i++)
					{
							   html1+='<tr>';
								 html1+='<td class="project-actions text-left"><img src="'+k[0][i].ImgAvatar+'" class="table-avatar" style="width:70px;height:70px;"/></td>';
								 ...
								 html1+='<td class="project-actions text-right"> <a class="btn btn-primary btn-sm btnDelete" href="deleteStory.php?idStory='+k[0][i].Id+'"><i class="fas fa-trash-alt"></i></a>';
