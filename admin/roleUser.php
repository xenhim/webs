...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
              ...
              <div class="form-group">
                <label for="inputDescription">Quyền</label>
                 ...
                 <select id="Level" class="form-control custom-select">
               	<?php
               	$arr_role=$db->GetListRole();
				   foreach($arr_role as $muc3)
					{
						if($Level==$muc3['Level']){
						   echo '<option selected value="'.$muc3['Level'].'">'.$muc3['Name'].'</option>'; 
						}else{
							 echo '<option value="'.$muc3['Level'].'">'.$muc3['Name'].'</option>'; 
						}
      ...
      <div class="row">
        <div class="col-12">
          <button type="button" class="btn btn-success" id="editRole" src-image="" src-path="">Lưu</button>
        </div>
      </div>
    </section>
    <!-- /.content -->
