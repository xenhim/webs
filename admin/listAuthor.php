				   ...
				   for(var i=0;i<k[0].length;i++)
					{
							   html1+='<tr id="s'+k[0][i].Id+'">';
								 ...
								 html1+='<td class="project-actions text-right"> <a class="btn btn-info btn-sm" href="editAuthor.php?idAuthor='+k[0][i].Id+'"><i class="fas fa-pencil-alt"></i></a>';
