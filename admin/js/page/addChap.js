	  ...
	  $("#addChap").click(function(){
	   ...
	   if(Name !=""){
		 $.ajax({     
	       ...
	       type:'POST',
	       cache:false,
	       data:{'IdStory':IdStory,'Name':Name,'Path':temp3,'Content':Content,'Content_01':Content_01,'Content_02':Content_02,'Content_03':Content_03,'Content_04':site,'Notify':Notify,'Summary':Summary,'Title':Title},
	       success:function(kq){
	       	var o = JSON.parse(kq);
	                 //console.log(kq);
	...
	$("#editChap").click(function(){
	   ...
	   if(Name!=""){
		 $.ajax({     
	       ...
	       type:'POST',
	       cache:false,
	       data:{'IdStory':IdStory,'IdChap':IdChap,'Name':Name,'Path':temp3,'Content':Content,'Content_01':Content_01,'Content_02':Content_02,'Content_03':Content_03,'Content_04':site,'Notify':Notify,'Summary':Summary,'Title':Title},
	       success:function(kq){
	       	var o = JSON.parse(kq);
	               // console.log(kq);
