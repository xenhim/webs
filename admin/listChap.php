...
<head>
  ...
  <title>Chapter | <?php echo $nameStory;?></title>
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Danh sách chapter</h1>
             <a href="addChap.php?idStory=<?php echo $idStory;?>"><button type="button" class="button is-danger btn btn-success"  title="Collapse">Thêm Chapter</button></a>
          </div>
          <div class="col-sm-6">
