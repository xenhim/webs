...
class config
{
	...
	{
			$sql="UPDATE Comics SET chapterNumber='$NameUpdate_Chap',chapterUpdatedAt='$DateUpdate_Chap' WHERE Id='$Id'";	
			mysqli_query($this->_conn, $sql);	          		
	}
...
function AddStory3($Name,$NameOther,$Status,$Content,$Avatar,$slug,$Waning,$Author,$Genre,$NameEncodeGenres,$Country,$DateUpload,$URL1,$URL2,$female,$male)
	{
		$hide_view=0;
		$Name1=mysqli_real_escape_string($this->_conn,$Name);
		$NameOther1=mysqli_real_escape_string($this->_conn,$NameOther);
		...
		$sql="INSERT INTO Comics (name,otherName,image,content,status,slug,chapterUpdatedAt,createdAt,updatedAt) VALUES ('$Name1','$NameOther1','$Avatar','$Content1','$Status','$slug','$DateUpload','$DateUpload','$DateUpload')";
...
//$sql="INSERT INTO qq_story (Name,NameOther,story_Status,Content,ImgAvatar,Badge,Waning,Author,Genre,NameEncodeGenres,Country,DateUpload,Url1,Url2,Female,Male,hide_view) VALUES ('$Name1','$NameOther1','$Status','$Content1','$Avatar','$Badge','$Waning','$Author1','$Genre','$NameEncodeGenres','$Country','$DateUpload','$URL1','$URL2','$female','$male','$hide_view')";
	...
	function AddChap($Name,$Content,$Notify,$Summary,$DateUpload,$IdStory,$Path,$Content_01,$Content_02,$Content_03,$Content_04,$Title,$url1="")
	{
		...
		$sql="INSERT INTO Chapters (comicId,chapterNumber,pictureUrls,chapterUpdatedAt,createdAt,updatedAt) VALUES ('$IdStory','$Name','$Path','$DateUpload','$DateUpload','$DateUpload')";
