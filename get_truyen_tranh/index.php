...
<div class="form-group">
  <label for="usr">Link: Trang truyện hỗ trợ getlink [truyenqq,nettruyen,truyenfull]</label></br>
...
<div class="form-group">
  ...
  <input type="radio" class="form-check-input" id="truyenqq" name="optradio" value="truyenqq">
  <label class="form-check-label" for="radio2">truyenqq</label>
  
  <input type="radio" class="form-check-input" id="truyenfull" name="optradio" value="truyenfull">
  <label class="form-check-label" for="radio2">truyenfull</label>
   ...
   var badge=$("#Badge").val();
	  ...
	  $('#getlink').prop("disabled", true); 
		...
		$.ajax({     
		   ...
		   type:'POST',
		   cache:false,
		   data:{'link':link,'country':country,'badge':badge,'checkall':x,'summarize':summarize,'waning':waning},
		   success:function(kq){
				//console.log(kq);		   
			   var o = JSON.parse(kq);
